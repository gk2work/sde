    ...
    <section id="contact" className="section contact" aria-label="Contact section">
      <div className="container">
        ...
        <div className="contact__grid">
          ...
          <div className="contact__info fade-in-left">
            ...
            <div className="contact__available">
              ...
              <div>
                ...
                <div className="contact__available-sub">Open to full-time &amp; freelance opportunities</div>
              </div>
            </div>

            <p className="contact__blurb">
              Whether you have a project, a role, or just want to connect — drop me a line. I reply to every message.
            </p>
          ...
          {/* Right: form */}
          <form className="contact__form fade-in-right" onSubmit={handleSubmit} aria-label="Contact form">
