...
const projects = [
  ...
  },
  {
    ...
    description: 'Multi-tenant SaaS for autonomous company management. Stripe billing across 5 pricing tiers, an app marketplace with revenue sharing, and 130+ business features run through a multi-agent system.',
  ...
  },
  {
    ...
    description: 'Code-intelligence platform for analysing and improving codebases. Static analysis across multiple languages, cyclomatic complexity metrics, tech debt tracking, and refactoring recommendations.',
  ...
  },
  {
    ...
    description: 'Visa guidance and immigration platform. REST backend with JWT auth and Cloudinary uploads, paired with a React/shadcn frontend covering visa types, country requirements, and step-by-step journeys.',
